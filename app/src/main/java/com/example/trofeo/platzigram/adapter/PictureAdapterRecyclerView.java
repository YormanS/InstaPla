package com.example.trofeo.platzigram.adapter;
...
import com.example.trofeo.platzigram.view.PictureDetailActivity;
...
public class PictureAdapterRecyclerView extends RecyclerView.Adapter<PictureAdapterRecyclerView.PictureViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PictureViewHolder pictureViewHolder, int i) {
        ...
        Picasso.with(activity).load(picture.getPicture()).into(pictureViewHolder.picture);
        ...
        pictureViewHolder.picture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    activity.startActivity(intent, ActivityOptionsCompat.makeSceneTransitionAnimation(activity, v, activity.getString(R.string.transitioname_picture)).toBundle());
                } else {
    ...
    class PictureViewHolder extends RecyclerView.ViewHolder {
        ...
        PictureViewHolder(@NonNull View itemView) {
            ...
            picture = itemView.findViewById(R.id.imageCardView);
